...
<body class="antialiased">
    <div
        class="relative sm:flex sm:justify-center sm:items-center min-h-screen  bg-center bg-trueGray-200  dark:trueGray-20 selection:bg-red-500 selection:text-white ">
    ...
    <div class="landing flex gap-40 items-center justify-evenly w-full">
        ...
        <div class='left'>
            ...
            <div class="mt-5 flex">
                ...
                <div class="w-[3.5rem] h-[3.5rem] bg-gray-200 rounded-[50%] absolute left-[30px] border-4 border-[#fdfdfd]"></div>
                <div class="w-[3.5rem] h-[3.5rem] bg-gray-200 rounded-[50%] absolute left-[60px] border-4 border-[#fdfdfd] "></div>
    ...
    {{--
            @if (Route::has('login'))
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right font-semibold text-lg">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-black hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                    @else
                        ...
                        <a href="{{ route('login') }}" class="  text-black rounded-2xl  px-6  py-2  ml-5">Discover</a>
                        <a href="{{ route('login') }}" class="  black rounded-2xl  px-6  py-2  ml-5">Categories</a>
                        <a href="{{ route('login') }}" class="  text-black rounded-2xl  px-6  py-2  ml-5">About Us</a>




                        <a href="{{ route('login') }}" class="  text-white rounded-2xl bg-black px-6  py-2  ml-5">Log in</a>


                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class=" bg-lime-500 px-6  py-2 rounded-2xl ml-4 text-black hover:text-gray-900 dark:text-black  ">Register</a>
                        @endif
                    @endauth
                </div>
            @endif --}}
