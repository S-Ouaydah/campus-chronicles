<x-app-layout>
    ...
    <div class="mx-[3%] 2xl:mx-[5%] 3xl:mx-[8%] ">
        ...
        <div>
            ...
            <div class="pt-5 flex">
                {{-- make for each following --}}

                @if ($following->isEmpty())
                    <div class="m-0 flex h-[200px] w-full items-center justify-center">

                        <h4 class="text-lg select-none">Seems like you haven't followed anyone yet! <a
                                class="font-medium" href="{{ route('explore') }}">Browse Podcasts</a> & enjoy
                            educational enlightenment.</h4>
                ...
                @else
                    ...
                    <div class=" flex flex-col text-center">
                        ...
                        <div class="bg-contain h-[150px] w-[150px] xl:h-[200px] xl:w-[200px] mr-5  bg-[#D9D9D9] rounded-full"
                             style="background-image:url('{{$follow->pfp_path? asset($follow->pfp_path) : 'https://i.ibb.co/BtDyWFb/5770f01a32c3c53e90ecda61483ccb08.jpg'}}')">
                        </div>
                        <div class="justify-center mr-5">
                            <a class="text-xl text-lime-600" href="{{route('profile.viewer',$follow->id)}}">{{ $follow->name }}</a>
                        </div>
                    </div>
                        @endforeach
                @endif
