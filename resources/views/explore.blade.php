                ...
                <div class="h-[30%] sm:h-[44%] w-full  bg-[#C0EE9B]  rounded-3xl  items-center justify-between inline-flex mb-4 mr-4 p-12">
                    <div class="flex-col justify-center items-start gap-[5px] inline-flex ">
                        <div class=" flex flex-col ">
                            <div class=" text-black font-medium text-2xl xl:text-3xl 2xl:text-3xl tracking-wide"><span class="font-bold"> Expand your knowledge!</span></div>
                    ...
                    <div class="justify-center items-center gap-[5px] hidden xl:flex ">
                        <div class="w-[419px] h-[237px] relative">
                            <img class="w-[419px] h-[237px] left-0 top-0 absolute" src="{{ asset('/circle.png') }}">
                            <img class="w-[105px] h-[148px] left-[140px] top-[23px] absolute" src="{{ asset('/arrow.png') }}">
                        </div>
                        <div class="w-[66px] justify-center items-end gap-2.5 flex">
                            <img class="w-[66px] mt-40 h-6" src="{{ asset('/logo-black.png') }}">
                        </div>
                    </div>
                </div>
